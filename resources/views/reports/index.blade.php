...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        @foreach ($months as $month)
            <div
                class="bg-white rounded-[16px] border border-slate-200 shadow-sm overflow-hidden flex flex-col transition-all hover:shadow-md hover:border-emerald-200">
                ...
                <div class="p-5 flex-1 bg-slate-50/50">
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            <p class="text-[12px] text-slate-500 font-medium mb-0.5">Masuk <span
                                    class="text-emerald-500 ml-1"><i class="bi bi-arrow-down"></i></span></p>
                            <p class="text-[15px] font-bold text-slate-800">{{ number_format($month['total_in']) }} <span
                                    class="text-[11px] font-normal text-slate-500">kg</span></p>
                        </div>
                        <div>
                            <p class="text-[12px] text-slate-500 font-medium mb-0.5">Keluar <span
                                    class="text-red-500 ml-1"><i class="bi bi-arrow-up"></i></span></p>
                            <p class="text-[15px] font-bold text-slate-800">{{ number_format($month['total_out']) }} <span
                                    class="text-[11px] font-normal text-slate-500">kg</span></p>
                        </div>
                    </div>
